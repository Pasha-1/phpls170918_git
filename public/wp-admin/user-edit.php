                        ...
                        <tr class="user-syntax-highlighting-wrap">
                            ...
                            <td>
                                <label for="syntax_highlighting"><input name="syntax_highlighting" type="checkbox"
                                                                        ...
                                                                        value="false" <?php if (!empty($profileuser->syntax_highlighting)) checked('false', $profileuser->syntax_highlighting); ?> /> <?php _e('Disable syntax highlighting when editing code'); ?>
                                </label>
                            </td>
                        </tr>
                    <?php endif; ?>
